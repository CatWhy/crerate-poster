...
export function drawImage(ctx, element, scale) {
    /**
        * beginPath()：在一个画布中开始子路径的一个新的集合
        * 也就是说：运行到这个函数时，context中止当前的路径，立即把当前的坐标设置为起点（0,0），开始一条新的路径
        */
    ctx.beginPath();
...
*/
CanvasRenderingContext2D.prototype.wrapText = function (text, x, y, maxWidth = 999, lineHeight = 12, scale) {
